	...
	r.Route("/api/v1", func(r chi.Router) {
		...
		r.Route("/posts", func(r chi.Router) {
			...
			r.Route("/{postID}", func(r chi.Router) {
				...
				r.Put("/", app.checkPostOwnership("moderator", app.updatePostByIdHandler)) // full update
				r.Patch("/", app.checkPostOwnership("moderator", app.updatePostHandler))   // partial update
